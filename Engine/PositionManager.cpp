...
PositionManager::PositionManager(const PositionManager& other)
{
}
...
void PositionManager::SetPosition(float x, float y, float z)
{
	m_positionX = x;
	m_positionY = y;
	m_positionZ = z;
...
void PositionManager::SetRotation(float x, float y, float z)
{
	m_rotationX = x;
	m_rotationY = y;
	m_rotationZ = z;
...
void PositionManager::GetPosition(float& x, float& y, float& z)
{
	x = m_positionX;
	y = m_positionY;
	z = m_positionZ;
...
void PositionManager::GetRotation(float& x, float& y, float& z)
{
	x = m_rotationX;
	y = m_rotationY;
	z = m_rotationZ;
...
void PositionManager::MoveForward(bool keydown)
{
	float radians;
...
void PositionManager::MoveBackward(bool keydown)
{
	float radians;
...
void PositionManager::MoveUpward(bool keydown)
{
...
void PositionManager::MoveDownward(bool keydown)
{
...
void PositionManager::LookUpward(bool keydown)
{
...
void PositionManager::LookDownward(bool keydown)
{
